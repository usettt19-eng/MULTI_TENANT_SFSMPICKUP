                  ...
                  {alerts.length === 0 ? (
                    ...
                    alerts.map(alert => (
                      <div key={alert.id} className="bg-white p-6 rounded-[2.2rem] shadow-sm border border-rose-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 group hover:shadow-md transition-all">
                        ...
                        <button
                          onClick={() => {
                            handleStudentSelectForRecord(alert.student_id);
                            setIsRecordModalOpen(true);
                          }}
                          className="bg-slate-50 text-slate-500 px-4 py-2 rounded-xl text-[10px] font-black hover:bg-slate-100 transition-all flex items-center justify-center gap-1 group-hover:bg-rose-600 group-hover:text-white shrink-0 self-start sm:self-auto"
                        >
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="bg-white rounded-[2.5rem] border border-slate-100 p-8 shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <button
                    onClick={() => setIsRecordModalOpen(true)}
                    className="w-full bg-slate-50 text-slate-400 font-black py-4 rounded-2xl text-[10px] uppercase tracking-widest hover:bg-indigo-50 hover:text-indigo-500 transition-all border border-slate-50 border-dashed hover:border-indigo-200 mt-4"
                  >
