        ...
        <div className="col-span-12 lg:col-span-4 space-y-5">
          ...
          <section className="bg-[#0f172a] p-6 rounded-xl shadow-2xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button onClick={() => setCurrentView('forms')} className="bg-[#1e293b] hover:bg-[#334155] p-5 rounded-lg flex flex-col items-center gap-2 transition-all border border-white/5">
